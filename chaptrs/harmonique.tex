...
\begin{figure}[!t]
    ...
    %\caption{\textbf{(a)} Comparaison in vitro de production lumineuse avec et sans nanoparticules ; mesures prises dans un mélange de 1 mL. \textbf{(b)} L'effet qu'a le temps d'incubation de \ch{SNP-Luc} dans une feuille de cresson}
  \end{figure}
